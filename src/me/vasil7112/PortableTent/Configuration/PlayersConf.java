...
public class PlayersConf {
	...
	public static void reloadCustomConfig() {
	    ...
	    customConfigFile = new File(PortableTent.plugin.getDataFolder(), "Players.yml");
	    }
	    customConfig = YamlConfiguration.loadConfiguration(customConfigFile);
	 
	    // Look for defaults in the jar
	    InputStream defConfigStream = PortableTent.plugin.getResource("Players.yml");
    ...
    public static void saveDefaultConfig() {
        ...
        if (!customConfigFile.exists()) {            
        	PortableTent.plugin.saveResource("Players.yml", false);
        }
    }
}
